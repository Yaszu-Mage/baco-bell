...
@onready var server_list := $Menu/Friends/ItemList
@onready var item = preload("res://assets/images/joyknobpng.png")
...
func add_player_character(peer_id):
	...
	var username = $Menu/VBoxContainer/TextEdit.text
	if username != "":
...
func _on_join_pressed() -> void:
	$Menu/Friends/ItemList.visible = true
	$Menu.visible = false
	var world_instance = world.instantiate()
	add_child(world_instance,true)
	multiplayer_peer.create_client("localhost", PORT)
